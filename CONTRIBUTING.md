...
We would love for you to contribute to the `fasthttp` and help make it even better than it is today!
...
we use the git commit messages to **generate the fasthttp change log**.
